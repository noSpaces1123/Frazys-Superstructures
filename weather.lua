        ...
        rainy = {
            ...
            update = function (self)
                if not SFX.rainy:isPlaying() then
                    ...
                    zutil.playsfx(SFX.rainy, 0.2 * Weather.strength + .02, 1)
                end
                ...
                if Weather.strength >= 0.5 then
                    ...
                    if Weather.windEvents.current >= Weather.windEvents.max then
                        ...
                        zutil.playsfx(SFX.wind, 0.4, 1)
                        zutil.playsfx(SFX.windWarning, 0.2, 1)
...
function DrawWeatherOverlay()
    ...
    elseif Weather.currentType == "hot" then
        ...
        for _ = 1, Weather.strength * 100 do
            ...
            local x, y, width = math.random(0, love.graphics.getWidth()), zutil.easeOutQuint(math.random()) * love.graphics.getHeight(), 3
